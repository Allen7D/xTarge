    ...
    <div class="protocol iec104">
        ...
        <div class="protocol-content">
            <el-form :model="configForm" ref="configForm" label-width="10px" class="demo-dynamic">
                ...
                <!--功能码限制 开始-->
                <fc-limit :fc_options="fc_options" :function_codes="configForm.function_codes"></fc-limit>
                <!--功能码限制 结束-->
...
<script>
    ...
    export default {
        ...
        methods: {
            showForm() {
                this.$alert('<strong>是否 <i>确定</i> 显示</strong>', 'IEC104 配置', {
                    dangerouslyUseHTMLString: true
                });
            },
            verifyForm() {
                this.$alert('<strong>是否 <i>确定</i> 验证</strong>', 'IEC104 配置', {
                    dangerouslyUseHTMLString: true
                });
            },
            submitForm() {
