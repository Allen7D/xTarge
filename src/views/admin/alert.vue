<template>
  <el-table :data="alertData" stripe border style="width: 1200px" height="1200">
    <el-table-column label="报警记录列表">
      ...
      <el-table-column prop="message" label="Message" width="">
      </el-table-column>
    </el-table-column>
  </el-table>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      getAlertData() {
        axios.get('/api/v1.0/alerts').then((res) => {
